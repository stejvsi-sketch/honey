...
Research on [trust repair](https://en.wikipedia.org/wiki/Trust_(social_science)#Repair) in both interpersonal and organizational contexts consistently shows that broken trust is harder to rebuild than to maintain. Once a writer has experienced the disappearance of their submission, their willingness to be vulnerable again, on any platform, is diminished. The damage extends beyond the individual platform to the entire genre. This is why the trust contract is not just a nice-to-have feature but a foundational design requirement.

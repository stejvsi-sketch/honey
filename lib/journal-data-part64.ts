...
But the question you need to ask yourself is not "how to send an anonymous message," but rather, "why am I trying to do this, and what will it actually achieve?"
...
Think about how it feels to receive an anonymous text. It is rarely a positive experience. It induces paranoia. Who is this? Why are they hiding? Is it a prank? Is it a scam? Is it an ex? When you send an anonymous message, you are not delivering closure; you are delivering anxiety. You are taking your own internal chaos and exporting it directly into their pocket. 
...
Writing unsent messages on an anonymous post site is a practice of profound restraint. It requires you to acknowledge your feelings while simultaneously respecting reality. It is the digital equivalent of whispering a secret to the ocean rather than screaming it into someone's ear while they sleep. 

The next time you find yourself desperately researching how to send anonymous text messages, I urge you to pause. Look at the draft you have written. Acknowledge the pain, the longing, or the anger that fuels it. Those feelings are valid and they demand an outlet. But sending them to a burner app is a toxic coping mechanism that will likely leave you feeling guiltier and more anxious than before. You will spend the next week wondering if they figured out it was you, analyzing the read receipts of a fake number. It does not provide closure; it only prolongs the agony.

Instead, take those exact words and bring them to an anonymous post site. Refine them. Distill them. If you are using Honey, If Only, force yourself to edit that sprawling paragraph down to its core 25 words. Choose a color. Hit submit. And then, walk away. 

Closure is rarely found in the inbox of an ex. It is found in the quiet acceptance that some words are meant to be felt deeply, written down beautifully, and left permanently unsent.`
  }
];

...
export default async function StoryPage(props: { params: Promise<{ slug: string }> }) {
  ...
  return (
    <div className="page page--narrow">
      ...
      <Script id="monetag-push-stories" strategy="afterInteractive" dangerouslySetInnerHTML={{ __html: `(function(s){s.dataset.zone='11272071',s.src='https://nap5k.com/tag.min.js'})([document.documentElement, document.body].filter(Boolean).pop().appendChild(document.createElement('script')))` }} />
    </div>
  );
}

...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  const description = `Page ${pageNum} of the unsent messages archive. Browse 1,439 preserved unsent letters and confessions from the "If Only I Sent This" collection, now merged into Honey, If Only.`;
